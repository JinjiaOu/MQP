...
# Function to calculate and output percentage values for each pick to a specified output file
def calculate_pick_percentages(input_file_path, output_file_path):
    ...
    output_data = []
    for item in data:
        pick_percentage = (item["Value"] / total_value) * 100
        output_item = {
            "Round": item["Round"],
            "Pick": item["Pick"],
            "Value": item["Value"],
...
# Example usage
input_file_path = 'E:/IdeaProjects/MQP/other_json/Draft Value chart.json'
output_file_path = 'E:/IdeaProjects/MQP/other_json/Draft Value chart_percentage.json'
